...
def a2bits_list(chars):
    ...
    for x in chars:
	print x
    print("a2bits_lisar=chr: "+str([bin(ord(x))[2:].rjust(8,"0") for x in chars]))
    ...
    for row in range(height):
        for col in range(width):
            if index + 3 <= len_message_bits :
                ...
                r = pixel[0]
		print("pixel (" + str(col) + ", " + str(row) +") R: " + str(r))
                g = pixel[1]
		print("pixel (" + str(col) + ", " + str(row) +") G: " + str(g))
                b = pixel[2]
		print("pixel (" + str(col) + ", " + str(row) +") B: " + str(b))
